...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'candycan.a2l': { 'candycan.a2l.AxisScale': ('01.a2l.html#axisscale', 'candycan/a2l.py'),
            ...
            'candycan.ccp.socket': { 'candycan.ccp.socket.CANFilter': ('vcantest/ccp.socket.html#canfilter', 'candycan/ccp/socket.py'),
                                     'candycan.ccp.socket.SET_MTA_context': ( 'vcantest/ccp.socket.html#set_mta_context',
                                                                              'candycan/ccp/socket.py'),
                                     'candycan.ccp.socket.ScapyCANSpecs': ( 'vcantest/ccp.socket.html#scapycanspecs',
                                                                            'candycan/ccp/socket.py'),
                                     'candycan.ccp.socket.ScapyCANSpecs.channel': ( 'vcantest/ccp.socket.html#scapycanspecs.channel',
                                                                                    'candycan/ccp/socket.py'),
                                     'candycan.ccp.socket.XLOAD_context': ( 'vcantest/ccp.socket.html#xload_context',
                                                                            'candycan/ccp/socket.py'),
                                     'candycan.ccp.socket.can_context': ('vcantest/ccp.socket.html#can_context', 'candycan/ccp/socket.py'),
                                     'candycan.ccp.socket.check_bus_type': ( 'vcantest/ccp.socket.html#check_bus_type',
                                                                             'candycan/ccp/socket.py'),
                                     'candycan.ccp.socket.check_can_type': ( 'vcantest/ccp.socket.html#check_can_type',
                                                                             'candycan/ccp/socket.py'),
                                     'candycan.ccp.socket.downlod_calib_data': ( 'vcantest/ccp.socket.html#downlod_calib_data',
                                                                                 'candycan/ccp/socket.py'),
                                     'candycan.ccp.socket.downlod_calib_data2': ( 'vcantest/ccp.socket.html#downlod_calib_data2',
                                                                                  'candycan/ccp/socket.py'),
                                     'candycan.ccp.socket.flash_xcp': ('vcantest/ccp.socket.html#flash_xcp', 'candycan/ccp/socket.py'),
                                     'candycan.ccp.socket.get_argparser': ( 'vcantest/ccp.socket.html#get_argparser',
                                                                            'candycan/ccp/socket.py'),
                                     'candycan.ccp.socket.npa_to_packed_buffer': ( 'vcantest/ccp.socket.html#npa_to_packed_buffer',
                                                                                   'candycan/ccp/socket.py'),
                                     'candycan.ccp.socket.upload_calib_data': ( 'vcantest/ccp.socket.html#upload_calib_data',
                                                                                'candycan/ccp/socket.py'),
                                     'candycan.ccp.socket.upload_calib_data2': ( 'vcantest/ccp.socket.html#upload_calib_data2',
                                                                                 'candycan/ccp/socket.py')},
