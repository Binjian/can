...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'candycan.a2l': { 'candycan.a2l.AxisScale': ('01.a2l.html#axisscale', 'candycan/a2l.py'),
            ...
            'candycan.ccp': { 'candycan.ccp.CANFilter': ('02.ccp.html#canfilter', 'candycan/ccp.py'),
                              ...
                              'candycan.ccp.scapy_SET_MTA_context': ('02.ccp.html#scapy_set_mta_context', 'candycan/ccp.py'),
                              'candycan.ccp.scapy_can_context': ('02.ccp.html#scapy_can_context', 'candycan/ccp.py'),
                              'candycan.ccp.scapy_load_context': ('02.ccp.html#scapy_load_context', 'candycan/ccp.py'),
