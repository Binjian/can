# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/04.data_link.ipynb.

# %% auto 0
__all__ = ['pp', 'repo', 'done', 'get_argparser', 'signal_usr1', 'send_msg', 'receive_message']

# %% ../nbs/04.data_link.ipynb 4
...
# %% ../nbs/04.data_link.ipynb 6
pp = PrettyPrinter(indent=4, width=80, compact=True)

# %% ../nbs/04.data_link.ipynb 7
